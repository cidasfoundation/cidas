...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Cidas blockchain to handle the consensus
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call cidas.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call cidas.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call cidas.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call cidas.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, error) {
