...
// Package bind generates Cidas contract Go bindings.
//
// Detailed usage document and tutorial available on the cidas Wiki page:
// https://github.com/cidas/cidas/wiki/Native-DApps:-Go-bindings-to-Cidas-contracts
package bind
