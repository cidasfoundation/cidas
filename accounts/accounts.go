...
// Package accounts implements high level Cidas account management.
package accounts
...
// Account represents an Cidas account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Cidas account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain cidas.ChainStateReader)
