...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "cids.ipc", false, filepath.Join(os.TempDir(), "cids.ipc")},
		{"data", "cids.ipc", false, "data/cids.ipc"},
		{"data", "./cids.ipc", false, "./cids.ipc"},
		{"data", "/cids.ipc", false, "/cids.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "cids.ipc", true, `\\.\pipe\cids.ipc`},
		{"data", "cids.ipc", true, `\\.\pipe\cids.ipc`},
		{"data", `\\.\pipe\cids.ipc`, true, `\\.\pipe\cids.ipc`},
	}
