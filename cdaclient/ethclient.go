...
// Package ethclient provides a client for the Cidas RPC API.
package ethclient
...
// Client defines typed wrappers for the Cidas RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, cidas.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*cidas.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (cidas.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q cidas.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q cidas.FilterQuery, ch chan<- types.Log) (cidas.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q cidas.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg cidas.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg cidas.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg cidas.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg cidas.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
