...
import (
	...
	"github.com/cidas/cidas/internal/jsre"
	"github.com/cidas/cidas/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Cidas requests through
...
// Welcome show summary of current Cids instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Cids metadata
	fmt.Fprintf(c.printer, "Welcome to the Cids JavaScript console!\n\n")
	c.jsre.Run(`
