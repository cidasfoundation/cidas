...
// stateObject represents an Cidas account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of cidas address of the account
	data     Account
	db       *StateDB
...
// Account is the Cidas consensus representation of accounts.
