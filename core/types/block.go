...
// Package types contains data types related to Cidas consensus.
package types
...
import (
	...
	"github.com/cidas/cidas/crypto/sha3"
...
// Header represents a block header in the Cidas blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) tocidser.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Cidas blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Cidas RLP block format.
