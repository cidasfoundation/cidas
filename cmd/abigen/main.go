...
import (
	...
	"github.com/cidas/cidas/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Cidas contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Cidas contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Cidas contract Solidity source to build and bind")
