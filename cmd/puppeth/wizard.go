...
type wizard struct {
	...
	services map[string][]string   // Cidas services known to be running on servers
...
// converts it to an Cidas address. If an empty line is entered, the default
// value is returned.
