...
// setting up a new or managing an existing Cidas private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Cidas private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Cidas network down to  |")
	...
	log.Info("Administering Cidas network", "name", w.network)
