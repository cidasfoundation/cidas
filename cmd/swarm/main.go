...
import (
	...
	"github.com/cidas/cidas/contracts/ens"
	...
	"github.com/cidas/cidas/swarm"
	bzzapi "github.com/cidas/cidas/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the Cidas API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the Cidas API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("cids"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside cids.
func init() {
...
var app = utils.NewApp(gitCommit, "Cidas Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The cidas Authors"
