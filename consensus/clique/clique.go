...
// ecrecover extracts the Cidas account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Cidas address
...
// Cidas testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Cidas address of the signing key
...
// Author implements consensus.Engine, returning the Cidas address recovered
