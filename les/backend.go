...
// Package les implements the Light Cidas Subprotocol.
package les
...
import (
	...
	rpc "github.com/cidas/cidas/rpc"
)

type LightCidas struct {
	odr         *LesOdr
	relay       *LesTxRelay
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightCidas, error) {
...
func (s *LightCidas) APIs() []rpc.API {
...
func (s *LightCidas) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightCidas) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightCidas) TxPool() *light.TxPool              { return s.txPool }
func (s *LightCidas) Engine() consensus.Engine           { return s.engine }
func (s *LightCidas) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightCidas) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightCidas) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightCidas) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// Cidas protocol implementation.
func (s *LightCidas) Start(srvr *p2p.Server) error {
