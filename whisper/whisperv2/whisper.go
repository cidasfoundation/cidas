...
import (
	...
	"github.com/cidas/cidas/crypto/ecies"
	"github.com/cidas/cidas/event/filter"
...
// Whisper represents a dark communication interface through the Cidas
...
// New creates a Whisper client ready to communicate through the Cidas P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
