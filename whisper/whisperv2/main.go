...
import (
	...
	"github.com/cidas/cidas/logger"
	"github.com/cidas/cidas/p2p"
	"github.com/cidas/cidas/p2p/nat"
	"github.com/cidas/cidas/whisper"
)
...
func main() {
	...
	// Create an Cidas peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Cidas peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Cidas peer: %v.\n", err)
		os.Exit(1)
	}
