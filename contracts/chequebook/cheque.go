...
// Package chequebook package wraps the 'chequebook' Cidas smart contract.
//
...
import (
	...
	"github.com/cidas/cidas/contracts/chequebook/contract"
	"github.com/cidas/cidas/core/types"
	"github.com/cidas/cidas/crypto"
	"github.com/cidas/cidas/log"
	"github.com/cidas/cidas/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an Cidas transaction.
