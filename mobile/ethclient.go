...
// Contains a wrapper for the Cidas client.
...
import (
	...
	"github.com/cidas/cidas/ethclient"
)

// CidasClient provides access to the Cidas APIs.
type CidasClient struct {
	client *ethclient.Client
}

// NewCidasClient connects a client to the given URL.
func NewCidasClient(rawurl string) (client *CidasClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &CidasClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *CidasClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *CidasClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *CidasClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *CidasClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *CidasClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *CidasClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *CidasClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *CidasClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *CidasClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *CidasClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *CidasClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *CidasClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *CidasClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *CidasClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *CidasClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *CidasClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *CidasClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *CidasClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *CidasClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *CidasClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *CidasClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *CidasClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *CidasClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *CidasClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *CidasClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *CidasClient) SendTransaction(ctx *Context, tx *Transaction) error {
