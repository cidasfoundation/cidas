...
import (
	...
	"github.com/cidas/cidas/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicCidasAPI provides an API to access Cidas full node-related
// information.
type PublicCidasAPI struct {
	e *Cidas
}

// NewPublicCidasAPI creates a new Etheruem protocol API for full nodes.
func NewPublicCidasAPI(e *Cidas) *PublicCidasAPI {
	return &PublicCidasAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicCidasAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicCidasAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicCidasAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Cidas) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Cidas) *PrivateMinerAPI {
...
// admin methods of the Cidas service.
func NewPrivateAdminAPI(eth *Cidas) *PrivateAdminAPI {
...
// related public debug methods of the Cidas service.
func NewPublicDebugAPI(eth *Cidas) *PublicDebugAPI {
...
// private debug methods of the Cidas service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *Cidas) *PrivateDebugAPI {
